...
const app = express();
const secretKey = "Heartbeat143";

const userToken = jwt.sign({ userId: 1, role: "user", email: "Darshu@email.com" }, secretKey, { expiresIn: "1h" });
 console.log("Usertoken:",userToken)
const adminToken = jwt.sign({ userId: 2, role: "admin", email: "Veeru@email.com" }, secretKey, { expiresIn: "1h" });
